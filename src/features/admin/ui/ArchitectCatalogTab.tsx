...
export function ArchitectCatalogTab() {
  ...
  return (
    <div className="space-y-6 p-4 text-foreground lg:p-8">
      <div>
        <h1 className="font-heading text-2xl font-bold text-foreground lg:text-3xl">{t("architectTitle")}</h1>
        <p className="mt-1 text-sm text-muted-foreground">{t("architectSubtitle")}</p>
      </div>
      ...
      <ConfirmDeleteDialog
        ...
        titleId="delete-architect-title"
      />
    </div>
  );
}
