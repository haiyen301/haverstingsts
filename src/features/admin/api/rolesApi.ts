...
export const MODULE_ALLOWED_ACTIONS: Record<RoleModule, RoleAction[]> = {
  ...
  admin_brands: STANDARD_MODULE_ACTIONS,
...
export const MODULE_SUPPORTS_VIEW_ALL: Record<RoleModule, boolean> = {
  ...
  admin_farms: true,
  admin_zones: true,
  admin_zone_configurations: true,
  admin_regrowth: true,
  admin_grasses: true,
  admin_key_areas: true,
  admin_fertilizer_product: true,
