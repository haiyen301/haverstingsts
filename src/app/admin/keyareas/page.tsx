  ...
  return createPortal(
    <div className="fixed inset-0 z-80">
      ...
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="keyarea-panel-title"
        className="absolute inset-0 flex flex-col bg-background shadow-2xl animate-in slide-in-from-right duration-300"
      >
        <div className="flex shrink-0 items-center justify-between border-b border-border px-4 py-4 lg:px-8">
          <h2 id="keyarea-panel-title" className="text-xl font-semibold">
            {title}
          </h2>
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-4 py-6 lg:px-8">
          <div className="mx-auto w-full max-w-2xl space-y-5">{children}</div>
        </div>
      </div>
    </div>,
    document.body,
